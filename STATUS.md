...
t = 25/24, in-window). And Gap 2's CR > 0 candidate SURVIVES both kill
geometries with margins +0.40/+0.80 — the surviving bridge's mechanism
is genuinely different, and proof effort now points there. Residual for
a fresh session: reviewer-level independence (022 was same-session; the
scope caveat is in the record).** Also: the deep-anneal
