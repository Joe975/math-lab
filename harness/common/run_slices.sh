...
#   slices (res/mod), filters each through cycle_filter, and writes each
#   slice's full output atomically to
#     $MATHLAB_OUT/g5n{N}_s{R}of{MOD}.txt
#   (MATHLAB_OUT defaults to ./out)
...
FILTER="${CYCLE_FILTER:-$TOOLS/../erdos-gyarfas/cycle_filter}"
